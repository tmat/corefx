...
namespace System.Reflection.Internal
{
    ...
    internal unsafe struct MemoryBlock
    {
            ...
            bool isReferenceSmall)
        {
            ...
            int startValue = PeekReference(startRowNumber * rowSize + referenceOffset, isReferenceSmall);
            int endValue = PeekReference(endRowNumber * rowSize + referenceOffset, isReferenceSmall);
            if (endRowNumber == 1)
            {
            ...
            while ((endRowNumber - startRowNumber) > 1)
            {
                ...
                int midReferenceValue = PeekReference(midRowNumber * rowSize + referenceOffset, isReferenceSmall);
            ...
            bool isReferenceSmall)
        {
            ...
            {
                int currReference = PeekReference(currOffset, isReferenceSmall);
            ...
            bool isReferenceSmall)
        {
            ...
            {
                int current = PeekReference(offset, isReferenceSmall);
                if (current < previous)
                {
                    return false;
                }
