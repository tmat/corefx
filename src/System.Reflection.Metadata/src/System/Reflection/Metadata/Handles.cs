...
namespace System.Reflection.Metadata
{
    ...
    public struct Handle : IEquatable<Handle>
    {
        ...
        private const int MaxValue = (1 << 29) - 1;
        ...
        internal static int Compare(Handle left, Handle right)
        {
            ...
            // We use the invariant that value is < 2^29 here.
            return (left._value | ((left._vType & (int)TokenTypeSmall.VirtualTokenMask) << 23)) -
                   (right._value | ((right._vType & (int)TokenTypeSmall.VirtualTokenMask) << 23));
        }
    ...
    public struct EntityHandle : IEquatable<EntityHandle>
    {
        ...
        {
            get { return _value & TokenTypeIds.VirtualBitAndRowIdMask; }
        }
        ...
        public HandleKind Kind
        {
            get { return TokenTypeSmall.ToHandleKind(Type >> TokenTypeIds.RowIdBitCount); }
        }
    ...
    public struct NamespaceDefinitionHandle : IEquatable<NamespaceDefinitionHandle>
    {
        ...
        {
            if (handle.TypeSmall < TokenTypeSmall.Namespace || handle.TypeSmall > TokenTypeSmall.MaxNamespace)
            {
                Handle.ThrowInvalidCast();
            }

            return new NamespaceDefinitionHandle(handle.VType, handle.Offset);
        }
