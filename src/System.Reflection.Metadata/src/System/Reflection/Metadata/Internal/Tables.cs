...
namespace System.Reflection.Metadata.Ecma335
{
    ...
    internal struct FieldPtrTableReader
    {
        ...
        {
            return this.Block.LinearSearchReference(this.RowSize, _FieldOffset, fieldDefRowId, _IsFieldTableRowRefSizeSmall) + 1;
        }
    }
    ...
    internal struct FieldTableReader
    {
        ...
        {
            int rowOffset = (handle.RowId - 1) * this.RowSize;
            return BlobHandle.FromIndex(this.Block.PeekHeapReference(rowOffset + _SignatureOffset, _IsBlobHeapRefSizeSmall));
        }
    }
    ...
    internal struct MethodPtrTableReader
    {
        ...
        {
            return this.Block.LinearSearchReference(this.RowSize, _MethodOffset, methodDefRowId, _IsMethodTableRowRefSizeSmall) + 1;
        }
    }
    ...
    internal struct ConstantTableReader
    {
        ...
        {
            int rowOffset = (handle.RowId - 1) * this.RowSize;
            return BlobHandle.FromIndex(this.Block.PeekHeapReference(rowOffset + _ValueOffset, _IsBlobHeapRefSizeSmall));
        }
    ...
    internal struct FieldMarshalTableReader
    {
        ...
        {
            int rowOffset = (rowId - 1) * this.RowSize;
            return BlobHandle.FromIndex(this.Block.PeekHeapReference(rowOffset + _NativeTypeOffset, _IsBlobHeapRefSizeSmall));
        }
    ...
    internal struct DeclSecurityTableReader
    {
        ...
        {
            int rowOffset = (rowId - 1) * this.RowSize;
            return BlobHandle.FromIndex(this.Block.PeekHeapReference(rowOffset + _PermissionSetOffset, _IsBlobHeapRefSizeSmall));
        }
...
#pragma warning restore 618 // Edit and continue API marked obsolete to give us more time to refactor
    ...
    internal struct AssemblyTableReader
    {
        ...
        {
            Debug.Assert(NumberOfRows == 1);
            return BlobHandle.FromIndex(this.Block.PeekHeapReference(_PublicKeyOffset, _IsBlobHeapRefSizeSmall));
        }
    ...
    internal struct AssemblyRefTableReader
    {
        ...
        {
            int rowOffset = (int)(rowId - 1) * this.RowSize;
            return BlobHandle.FromIndex(this.Block.PeekHeapReference(rowOffset + _PublicKeyOrTokenOffset, _IsBlobHeapRefSizeSmall));
        }
        ...
        {
            int rowOffset = (int)(rowId - 1) * this.RowSize;
            return BlobHandle.FromIndex(this.Block.PeekHeapReference(rowOffset + _HashValueOffset, _IsBlobHeapRefSizeSmall));
        }
    }
    ...
    internal struct ExportedTypeTableReader
    {
        ...
        internal uint GetTypeDefId(int rowId)
        {
            int rowOffset = (rowId - 1) * this.RowSize;
    ...
    internal struct MethodSpecTableReader
    {
        ...
        {
            int rowOffset = (handle.RowId - 1) * this.RowSize;
            return BlobHandle.FromIndex(this.Block.PeekHeapReference(rowOffset + _InstantiationOffset, _IsBlobHeapRefSizeSmall));
        }
    }
